...
WSGI_APPLICATION = 'pe_platform.wsgi.application'

# Database — uses DATABASE_URL on Railway (Postgres), falls back to SQLite for dev
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('POSTGRES_DB', 'pe_platform'),
...
# CORS — allow React dev server and any Railway domain
